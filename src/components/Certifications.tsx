        ...
        {certificationsData.length > 0 ? (
          <div className="grid grid-cols-3 gap-6 lg:gap-8">
                ...
                <AnimatedPanel
                  ...
                  <div className="flex-grow mb-4">
                    <div className="flex items-start mb-3">
                      ...
                      <h3 className="text-base md:text-lg font-semibold text-accent group-hover:text-accent-hover transition-colors leading-tight">
                        {cert.name}
                      </h3>
                    </div>
            ...
            <AnimatedPanel
              ...
              <h3 className="font-fira_code text-base md:text-lg text-secondary-text group-hover:text-primary-text transition-colors duration-300">
                More Certifications
              </h3>
