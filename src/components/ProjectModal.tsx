  ...
  return createPortal(
    <div
      ...
      >
        <Panel
          variant="simple"
          className="overflow-y-auto flex-1 !p-0 glass-effect">
          <button
            onClick={onClose}
            aria-label="Close project details"
            className="absolute top-3 right-3 z-20 p-2 rounded-full text-white bg-black/40 hover:bg-black/60 transition-colors">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4 border-t border-border">
              {project.liveLink && (
                <a
                  ...
                  className="btn-secondary grow inline-flex items-center justify-center"> {/* UPDATED */}
