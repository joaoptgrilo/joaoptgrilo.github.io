  ...
  theme: {
    extend: {
      colors: { 
        ...
        'light-panel-bg': 'rgba(173, 216, 230, 0.4)', // LightSkyBlue at 40% opacity (ADD8E6)
      },
      fontFamily: { 
      ...
      animation: {
        ...
        'glow-shadow': 'diffuseGlowShadowKeyframes 3s ease-in-out infinite alternate', // Using diffuse glow
      },
      keyframes: {
        blinkKeyframes: { 
          'from, to': { opacity: '0' },
